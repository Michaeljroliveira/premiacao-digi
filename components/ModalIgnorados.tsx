...
export default function ModalIgnorados({
  ...
  return (
    <>
      <div className="fixed inset-0 bg-black/50 z-50" onClick={onFechar} />
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-2xl max-w-5xl w-full max-h-[90vh] overflow-hidden flex flex-col">
          <div className="bg-red-600 text-white p-6 flex justify-between items-center">
            ...
            <button onClick={onFechar} className="text-3xl hover:opacity-80">
              ×
            </button>
          </div>
          ...
          <div className="flex-1 overflow-y-auto p-6">
            <table className="w-full text-sm">
              ...
              <tbody>
                {ignorados.map((wo, i) => (
                  <tr key={`${wo.id}-${i}`} className="border-b hover:bg-red-50">
